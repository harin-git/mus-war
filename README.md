This repo contains code for the paper "**Unsettled Times: Music Discovery Reveals Divergent Cultural Responses to War**". To reproduce our analyses you will need some or all of these files.
