This repo contains code for the paper "**Global music engagement reveals cultural shifts during the war in Ukraine**". To reproduce our analyses you will need some or all of these files.
